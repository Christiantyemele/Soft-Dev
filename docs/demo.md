...
- **Shared directory** — A `sprintless/pairs/forge-1/shared/` directory where FORGE and SENTINEL communicate through files. This is the heart of the pair harness.
...
- **Inspect the shared directory**: `ls ~/.agentflow/workspaces/<repo>/sprintless/pairs/forge-1/shared/` shows you exactly where the pair is in the lifecycle.
