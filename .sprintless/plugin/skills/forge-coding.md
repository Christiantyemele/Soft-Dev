...
- All standards are in `.agent/standards/CODING.md` (if it exists)
- All architecture patterns are in `.agent/arch/patterns.md` (if it exists)
- API contracts are in `.agent/arch/api-contracts.md` (if it exists)
...
- Run tests after every segment: `.agent/tooling/run-tests.sh`
